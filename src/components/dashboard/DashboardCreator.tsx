...
export function DashboardCreator({ 
  ...
  const createDashboard = async () => {
    ...
    setCreating(true);
    try {
      console.log('Criando dashboard:', { uploadId, title, userId: user.id });
      ...
      console.log('Dashboard criado:', dashboard.id);
      ...
      console.log('Dados associados ao dashboard:', updateCount);
